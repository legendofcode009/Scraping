...
import { formatDate } from "../utlis/functions"
    ...
    <li className="mb-10 ms-7">
        ...
        <div className="flex gap-2 items-center flex-wrap">
            ...
            <span
              ...
              py-2.5 rounded-full flex items-center gap-1"
            >
                <FaRegStar /> {repo.stargazers_count}
            </span>
            <span
              className="bg-purple-100 text-purple-800 text-xs font-medium px-2.5
              py-2.5 rounded-full flex items-center gap-1"
            >
        ...
        <img src={"./new_icons/javascript.svg"} alt='Programming language icon' className="h-8" />
    </li>
  )
}
