...
const Search = ({onSearch}) => {
  ...
  return (
    ...
    <form className='max-w-x1 mx-auto p-2'
    ...
    >
        ...
        <div className="relative">
            ...
            <button
              ...
              focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 bg-gradient-to-r
              form-cyan-900 to-blue-900 hover:scale-95 active:scale-90 tramsition-all duration-300"
            >
                Search
            </button>
        </div>
